  ...
  private async generateConfigFile(configDir: string, jobConfig: JobConfig, databases: DatabaseConfig[], outputs: any[]): Promise<void> {
    ...
    if (databases.length > 1) {
      ...
      "Entity - Has Access To Name": $append(
        has_super_priv ? [{"Entity - Has Access To Name": "Super" & "::" & %.connection_info.db_name & "::" & %.connection_info.region, "Entity - Has Access To Source ID": "super-priv-001" & "::" & %.connection_info.db_name & "::" & %.connection_info.region, "Entity - Has Access To Entity Type": "connection", "Entity - Has Access To Source Type": "role", "Entity - Has Access To Permission Name": "access"}] : [],
        has_create_user_priv ? [{"Entity - Has Access To Name": "Create User" & "::" & %.connection_info.db_name & "::" & %.connection_info.region, "Entity - Has Access To Source ID": "create-user-priv-001" & "::" & %.connection_info.db_name & "::" & %.connection_info.region, "Entity - Has Access To Entity Type": "connection", "Entity - Has Access To Source Type": "role", "Entity - Has Access To Permission Name": "access"}] : [],
        has_create_priv ? [{"Entity - Has Access To Name": "Create" & "::" & %.connection_info.db_name & "::" & %.connection_info.region, "Entity - Has Access To Source ID": "create-priv-001" & "::" & %.connection_info.db_name & "::" & %.connection_info.region, "Entity - Has Access To Entity Type": "connection", "Entity - Has Access To Source Type": "role", "Entity - Has Access To Permission Name": "access"}] : [],
        has_insert_priv ? [{"Entity - Has Access To Name": "Insert" & "::" & %.connection_info.db_name & "::" & %.connection_info.region, "Entity - Has Access To Source ID": "insert-priv-001" & "::" & %.connection_info.db_name & "::" & %.connection_info.region, "Entity - Has Access To Entity Type": "connection", "Entity - Has Access To Source Type": "role", "Entity - Has Access To Permission Name": "access"}] : [],
        has_update_priv ? [{"Entity - Has Access To Name": "Update" & "::" & %.connection_info.db_name & "::" & %.connection_info.region, "Entity - Has Access To Source ID": "update-priv-001" & "::" & %.connection_info.db_name & "::" & %.connection_info.region, "Entity - Has Access To Entity Type": "connection", "Entity - Has Access To Source Type": "role", "Entity - Has Access To Permission Name": "access"}] : [],
        has_delete_priv ? [{"Entity - Has Access To Name": "Delete" & "::" & %.connection_info.db_name & "::" & %.connection_info.region, "Entity - Has Access To Source ID": "delete-priv-001" & "::" & %.connection_info.db_name & "::" & %.connection_info.region, "Entity - Has Access To Entity Type": "connection", "Entity - Has Access To Source Type": "role", "Entity - Has Access To Permission Name": "access"}] : [],
        has_select_priv ? [{"Entity - Has Access To Name": "Select" & "::" & %.connection_info.db_name & "::" & %.connection_info.region, "Entity - Has Access To Source ID": "select-priv-001" & "::" & %.connection_info.db_name & "::" & %.connection_info.region, "Entity - Has Access To Entity Type": "connection", "Entity - Has Access To Source Type": "role", "Entity - Has Access To Permission Name": "access"}] : [],
        has_drop_priv ? [{"Entity - Has Access To Name": "Drop" & "::" & %.connection_info.db_name & "::" & %.connection_info.region, "Entity - Has Access To Source ID": "drop-priv-001" & "::" & %.connection_info.db_name & "::" & %.connection_info.region, "Entity - Has Access To Entity Type": "connection", "Entity - Has Access To Source Type": "role", "Entity - Has Access To Permission Name": "access"}] : [],
        has_grant_priv ? [{"Entity - Has Access To Name": "Grant" & "::" & %.connection_info.db_name & "::" & %.connection_info.region, "Entity - Has Access To Source ID": "grant-priv-001" & "::" & %.connection_info.db_name & "::" & %.connection_info.region, "Entity - Has Access To Entity Type": "connection", "Entity - Has Access To Source Type": "role", "Entity - Has Access To Permission Name": "access"}] : [],
        (!has_super_priv and !has_create_user_priv and !has_create_priv and !has_insert_priv and !has_update_priv and !has_delete_priv and !has_drop_priv and !has_grant_priv and has_select_priv) ? [{"Entity - Has Access To Name": "Read Only" & "::" & %.connection_info.db_name & "::" & %.connection_info.region, "Entity - Has Access To Source ID": "read-only-001" & "::" & %.connection_info.db_name & "::" & %.connection_info.region, "Entity - Has Access To Entity Type": "connection", "Entity - Has Access To Source Type": "role", "Entity - Has Access To Permission Name": "access"}] : [],
        (!has_super_priv and !has_create_user_priv and !has_create_priv and !has_insert_priv and !has_update_priv and !has_delete_priv and !has_select_priv and !has_drop_priv and !has_grant_priv) ? [{"Entity - Has Access To Name": "No Access" & "::" & %.connection_info.db_name & "::" & %.connection_info.region, "Entity - Has Access To Source ID": "no-access-001" & "::" & %.connection_info.db_name & "::" & %.connection_info.region, "Entity - Has Access To Entity Type": "connection", "Entity - Has Access To Source Type": "role", "Entity - Has Access To Permission Name": "access"}] : []
